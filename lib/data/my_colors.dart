...
class MyColors {
  static const Color primary = Color(0xFF422F0B);
  static const Color primaryLight = Color(0xFF23BFBE);

  //static const Color primary = Color(0xFF006190);
  static const Color primaryDark = Color(0xFF0B6262);

  //static const Color primaryLight = Color(0xFFF7F7EA);
  static const Color accent = Color(0xFFECC60F);
  ...
  static const Color overlay_light_5 = Color(0x0dffffff);
  ...
  static const Color overlay_dark_5 = Color(0x0d000000);
